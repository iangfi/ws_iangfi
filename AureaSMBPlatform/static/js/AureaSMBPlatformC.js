...
(function() {
  ...
  AureaSMBPlatform.AureaSMBPlatformC = Trillo.inherits(Shared.AppC, function(viewSpec) {
    Shared.AppC.call(this, viewSpec);
  });

  var AureaSMBPlatformC = AureaSMBPlatform.AureaSMBPlatformC.prototype;
  var AppC = Shared.AppC.prototype;

  AureaSMBPlatformC.handleAction = function(actionName, selectedObj) {
